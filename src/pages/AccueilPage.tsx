...
export const AccueilPage: React.FC<AccueilPageProps> = ({
  ...
  return (
    <div className="relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-8 items-center">
            ...
            <div className="lg:col-span-6 relative">
              {/* Organic curved shape background highlight */}
              <div className="absolute -inset-4 bg-gradient-to-tr from-[#dfeee7] to-[#eef6f3] rounded-3xl -rotate-1 transform -z-10" />
              ...
              <div className="relative rounded-3xl overflow-hidden shadow-2xl border-4 border-white aspect-[4/3] sm:aspect-[16/11]">
                ...
                {/* Badge Overlay */}
                <div className="absolute bottom-4 left-4 bg-black/40 backdrop-blur-md px-3.5 py-1.5 rounded-full text-white text-[11px] font-medium tracking-wide">
                ...
                <div className="absolute bottom-4 right-4 bg-white/90 backdrop-blur-md rounded-full px-3 py-1.5 flex items-center gap-3 text-xs font-semibold text-[#1b3d36] shadow">
                  <button
      ...
      <section className="bg-[#183931] text-white py-6">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-6">
            <div className="font-script text-2xl sm:text-3xl text-emerald-200 shrink-0 text-center lg:text-left">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-6 sm:gap-8 w-full lg:w-auto">
              ...
              <div className="flex flex-col items-center text-center gap-1.5 col-span-2 sm:col-span-1">
      ...
      {/* ================= 5. RESTAURANT ROOFTOP & FITNESS (FROM ACCUEIL 1) ================= */}
      <section className="py-16 sm:py-20 bg-white relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between mb-10 gap-4">
            <div>
          ...
          {/* Two Large Cards: Restaurant Rooftop & Espace Fitness */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {/* Card 1: Restaurant Rooftop */}
            <div
              onClick={() => onNavigate('restaurant')}
              className="group relative rounded-2xl overflow-hidden shadow-lg cursor-pointer aspect-[16/10]"
            >
              <img
                src="https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?auto=format&fit=crop&w=1000&q=80"
                alt="Restaurant Rooftop au coucher du soleil"
                className="w-full h-full object-cover group-hover:scale-105 transition duration-500"
              />
              ...
              <div className="absolute bottom-6 left-6 right-6 text-white space-y-2">
                ...
                <h3 className="font-serif text-2xl font-bold">Restaurant Rooftop</h3>
                <p className="text-xs text-gray-200 leading-relaxed max-w-sm">
                  Une cuisine raffinée au sommet de la ville, dans un cadre unique avec vue panoramique.
                </p>
                <div className="inline-flex items-center gap-2 text-xs font-semibold text-emerald-300 group-hover:text-white transition pt-1">
            ...
            >
              ...
              <div className="absolute bottom-6 left-6 right-6 text-white space-y-2">
                ...
                <h3 className="font-serif text-2xl font-bold">Espace Fitness</h3>
                <p className="text-xs text-gray-200 leading-relaxed max-w-sm">
                  Restez en forme durant votre séjour avec un espace moderne, équipé et accessible à tout moment.
                </p>
                <div className="inline-flex items-center gap-2 text-xs font-semibold text-emerald-300 group-hover:text-white transition pt-1">
                  <span>Voir l'espace fitness</span>
                  <ArrowRight className="w-3.5 h-3.5" />
                </div>
              </div>
            </div>
